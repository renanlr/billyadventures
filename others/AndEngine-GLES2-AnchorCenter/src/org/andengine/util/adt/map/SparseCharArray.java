...
/**
 * SparseCharArrays map integers to chars.
 * Unlike a normal array of chars
...
public class SparseCharArray implements Cloneable {
    ...
    /**
     * Creates a new SparseCharArray containing no mappings that will not
     * require any additional memory allocation to store the specified
     * number of mappings.
     */
    public SparseCharArray(int initialCapacity) {
        initialCapacity = ArrayUtils.idealIntArraySize(initialCapacity);

        mKeys = new int[initialCapacity];
        mValues = new char[initialCapacity];
        mSize = 0;
    }

    @Override
    public SparseCharArray clone() {
        SparseCharArray clone = null;
        try {
            clone = (SparseCharArray) super.clone();
    ...
    /**
     * Gets the char mapped from the specified key, or <code>'\0'</code>
    ...
    /**
     * Gets the char mapped from the specified key, or the specified value
     * if no such mapping has been made.
     */
    public char get(int key, char valueIfKeyNotFound) {
    ...
    /**
     * Returns the number of key-value mappings that this SparseCharArray
     * currently stores.
     */
    public int size() {
        return mSize;
